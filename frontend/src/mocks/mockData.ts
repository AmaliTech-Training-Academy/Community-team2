...
export const MOCK_POSTS: Post[] = [
  {
    ...
    comments: makeComments(1, [
      ...
      [
        103,
        "Priya Nair",
        "I can bring my portable speaker setup for the music corner!",
      ],
    ]),
  },
  {
    ...
    comments: makeComments(2, [
      [
        104,
        "Sofia Reyes",
        "Saw a dog matching this description near the park this morning! Will keep an eye out.",
      ],
      [
        105,
        "Alex Morgan",
        "Sharing this on the community board. Hope you find him soon!",
      ],
    ]),
  },
  {
    ...
    comments: makeComments(3, [
      [
        106,
        "Kwame Asante",
        "Grounds & Glory is my go-to! Their oat milk latte is 🔥",
      ],
      [107, "Priya Nair", "Adding The Bean Scene to my list, thanks!"],
      [
        108,
        "Sofia Reyes",
        "Morning Ritual just started a loyalty card scheme too.",
      ],
    ]),
  },
  {
  ...
  },
  {
    ...
    comments: makeComments(5, [
      ...
      [
        113,
        "Kwame Asante",
        "The digital media lab sounds incredible. Any details on what equipment they'll have?",
      ],
    ]),
  },
  {
  ...
  },
  {
    ...
    comments: makeComments(8, [
      [
        117,
        "Kwame Asante",
        "Mike from FixIt Fast on Grove St — call 555-0134. Very reliable, fair prices.",
      ],
      [
        118,
        "Alex Morgan",
        "Seconding Mike! Fixed our boiler last winter, no issues since.",
      ],
    ]),
  },
  {
    ...
    comments: makeComments(9, [
      [
        119,
        "Jordan Lee",
        "Thanks for the heads up! Birch Road will be packed.",
      ],
      [
        120,
        "Sofia Reyes",
        "This is going to be a nightmare for the school run.",
      ],
  ...
  },
  {
    ...
    comments: makeComments(10, [
      [
        122,
        "Priya Nair",
        "Went last night after seeing this — the green curry was amazing!",
      ],
...
export const MOCK_AUTH_RESPONSES: Record<
  string,
