...
export const TEST_IDS = {
  ...
  NAVBAR: {
    ...
    USER_MENU_TRIGGER: 'navbar-user-menu-trigger',
  ...
  POST_CARD: {
    ...
    BADGE:         (cat: string) => `badge-${cat.toLowerCase().replace(/[^a-z]/g, '-')}`,
  },
  ...
  POST_MODAL: {
    ...
    CAT_OPTION:   (cat: string) => `post-category-option-${cat.toLowerCase().replace(/[^a-z]/g, '-')}`,
  ...
  DASHBOARD: {
    ...
    STAT_CAT_CARD:  (cat: string) => `stat-card-cat-${cat.toLowerCase().replace(/[^a-z]/g, '-')}`,
    STAT_CAT_VALUE: (cat: string) => `stat-value-cat-${cat.toLowerCase().replace(/[^a-z]/g, '-')}`,

    CHART_PER_CATEGORY:       'chart-posts-per-category',
    CHART_PER_CATEGORY_TITLE: 'chart-posts-per-category-title',
    CHART_BY_DAY:             'chart-activity-by-day',
    CHART_BY_DAY_TITLE:       'chart-activity-by-day-title',
