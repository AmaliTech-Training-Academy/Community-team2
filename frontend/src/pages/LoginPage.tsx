...
export default function LoginPage() {
  ...
  return (
    <div data-testid="login-page" className=" bg-background rounded-3xl  border-0 md:border md:border-gray-200  pb-40 md:py-8 md:px-8  w-full max-w-md flex flex-col gap-2.5">
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-9 pr-3 py-2.5 rounded-lg bg-primary text-body-lg text-blue-gray-light  focus:outline-none transition-colors border ${
              errors.email
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-9 pr-9 py-2.5 rounded-lg text-body-lg bg-primary text-blue-gray-light focus:outline-none transition-colors border ${
              errors.password
                ? 'border-red-400 bg-red-50'
                : 'border-gray-200 bg-gray-100 focus:border-navy focus:bg-white'
            }`}
